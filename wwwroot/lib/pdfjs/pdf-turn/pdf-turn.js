...
var bookFlip = {
	...
	resize: function(){
		...
		$('#viewer').append('<div class="directions"> <a  class="prev-button"></a> <a  class="next-button"></a></div>');
		$(".directions .prev-button").click(function(e){
			e.preventDefault();
			$('#viewer').turn("previous");
		});

		$(".directions .next-button").click(function(e){
			e.preventDefault();
			$('#viewer').turn("next");
		});
